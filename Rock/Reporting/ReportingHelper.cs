                    ...
                    foreach ( var dataViewFilterOverride in dataViewFilterOverrideList.ToList().Where( a => a.IncludeFilter == true ) )
                    {
                        ...
                        if ( originalFilter != null )
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    Debug.WriteLine( $"\nNot using persisted version of the following dataviews because {originalFilter.Selection} has be customized:\n{originalFilter.ImpactedDataViewNames.ToList().AsDelimited( "\n" )} \n" );
