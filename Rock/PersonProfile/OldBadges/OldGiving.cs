...
namespace Rock.PersonProfile.Badge
{
    ...
    /// Giving Badge
    /// </summary>
    [Description( "Old - This badge highlights if the person has made a contribution within the provided date range." )]
    [Export( typeof( BadgeComponent ) )]
    [ExportMetadata( "ComponentName", "Old Giving" )]
...
" )]
    public class OldGiving : BadgeComponent
    {
        /// <summary>
