...
namespace Rock.PersonProfile.Badge
{
    ...
    /// </summary>
    [Description( "Old - Shows the top person badge and the number of signals." )]
    [Export( typeof( BadgeComponent ) )]
    [ExportMetadata( "ComponentName", "Old Top Person Signal" )]

    public class OldTopPersonSignal : BadgeComponent
    {
        /// <summary>
