...
namespace Rock.PersonProfile.Badge
{
    ...
    /// </summary>
    [Description( "Old - Shows the number of interactions in a given date range." )]
    [Export( typeof( BadgeComponent ) )]
    [ExportMetadata( "ComponentName", "Old Interaction In Range" )]
    ...
    public class OldInteractionsInRange : BadgeComponent
    {
        /// <summary>
