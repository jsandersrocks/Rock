...
namespace Rock.PersonProfile.Badge
{
    ...
    /// </summary>
    [Description( "Old - Shows a chart of the attendance history with each bar representing one month." )]
    [Export( typeof( BadgeComponent ) )]
    [ExportMetadata( "ComponentName", "Old Family Attendance" )]
    ...
    public class OldFamilyAttendance : BadgeComponent
    {
        /// <summary>
