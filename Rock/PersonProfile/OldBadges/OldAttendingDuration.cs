...
namespace Rock.PersonProfile.Badge
{
    ...
    /// </summary>
    [Description( "Old - Badge that summarizes how long someone has been attending." )]
    [Export( typeof( BadgeComponent ) )]
    [ExportMetadata( "ComponentName", "Old Attending Duration" )]
    
    public class OldAttendingDuration : BadgeComponent
    {
