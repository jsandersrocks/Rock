...
namespace Rock.PersonProfile.Badge
{
    ...
    /// </summary>
    [Description( "Old - This badge looks at the person's attendance of a provided group type and highlight if they have attended within the provided duration." )]
    [Export( typeof( BadgeComponent ) )]
    [ExportMetadata( "ComponentName", "Old Attended Group Of Type" )]
...
" )]
    public class OldGroupTypeAttendance : BadgeComponent
    {
        /// <summary>
