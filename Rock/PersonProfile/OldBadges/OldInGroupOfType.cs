...
namespace Rock.PersonProfile.Badge
{
    ...
    /// </summary>
    [Description( "Old - Shows badge if the individual is in a group of a specified type." )]
    [Export( typeof( BadgeComponent ) )]
    [ExportMetadata( "ComponentName", "Old In Group Of Type" )]
    ...
    public class OldInGroupOfType : BadgeComponent
    {
        /// <summary>
