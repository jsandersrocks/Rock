...
namespace Rock.PersonProfile.Badge
{
    ...
    /// Sequence Badge
    /// </summary>
    [Description( "Old - Shows a chart of the engagement history with each bar representing one month or day depending on the sequence." )]
    [Export( typeof( BadgeComponent ) )]
    [ExportMetadata( "ComponentName", "Old Sequence Engagement" )]
    ...
    public class OldSequenceEngagement : BadgeComponent
    {
        #region Keys
