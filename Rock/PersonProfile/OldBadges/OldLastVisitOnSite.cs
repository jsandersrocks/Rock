...
namespace Rock.PersonProfile.Badge
{
    ...
    /// </summary>
    [Description( "Old - Badge showing the number of days since the person last visited a specified site." )]
    [Export( typeof( BadgeComponent ) )]
    [ExportMetadata( "ComponentName", "Old Last Visit on Site" )]
    ...
    public class OldLastVisitOnSite : BadgeComponent
    {        
        /// <summary>
