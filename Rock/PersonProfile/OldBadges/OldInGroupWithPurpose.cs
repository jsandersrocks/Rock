...
namespace Rock.PersonProfile.Badge
{
    ...
    /// </summary>
    [Description( "Old - Shows badge if the individual is in a group where it's group type has a specified purpose (e.g. Serving)." )]
    [Export( typeof( BadgeComponent ) )]
    [ExportMetadata( "ComponentName", "Old In Group With Purpose" )]
    ...
    public class OldInGroupWithPurpose : BadgeComponent
    {        
        /// <summary>
