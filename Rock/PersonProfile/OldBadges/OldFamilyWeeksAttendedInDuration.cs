...
namespace Rock.PersonProfile.Badge
{
    ...
    /// </summary>
    [Description( "Old - Shows the number of times a family attended in a duration of weeks." )]
    [Export( typeof( BadgeComponent ) )]
    [ExportMetadata( "ComponentName", "Old Family Weeks Attended In Duration" )]
    
    [IntegerField("Duration", "The number of weeks to use for the duration (default 16.)", false, 16)]
    public class OldFamilyWeeksAttendedInDuration : BadgeComponent
    {        
        /// <summary>
