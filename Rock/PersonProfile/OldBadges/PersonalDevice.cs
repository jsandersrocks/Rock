...
namespace Rock.PersonProfile.Badge
{
    ...
    /// </summary>
    [Description( "Old - Badge showing the number of devices configured for the person." )]
    [Export( typeof( BadgeComponent ) )]
    [ExportMetadata( "ComponentName", "Old Personal Device" )]
    ...
    public class OldPersonalDevice : BadgeComponent
    {
        /// <summary>
