...
namespace Rock.PersonProfile.Badge
{
    ...
    /// 
    /// </summary>
    [Description( "Old - Displays a badge if person is in a chosen DataView." )]
    [Export( typeof( BadgeComponent ) )]
    [ExportMetadata( "ComponentName", "Old In Data View" )]
    ...
    public class OldInDataView : BadgeComponent
    {
